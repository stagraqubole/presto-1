...
public class TestHiveSplit
{
    ...
    public void testJsonRoundTrip()
    {
        ...
        assertFalse(actual.getDeleteDetlaLocations().isPresent());
    }
    ...
    public void testJsonRoundTripWithDeleteDeltas()
    {
        ...
        testJsonRoundTripWithDeleteDeltasHelper(deleteDeltaLocations);
    }

    @Test
    public void testJsonRoundTripWithEmptyDeleteDeltas()
    {
        DeleteDeltaLocations deleteDeltaLocations = new DeleteDeltaLocations();
        testJsonRoundTripWithDeleteDeltasHelper(deleteDeltaLocations);
    }

    private void testJsonRoundTripWithDeleteDeltasHelper(DeleteDeltaLocations deleteDeltaLocations)
    {
        Properties schema = new Properties();
        schema.setProperty("foo", "bar");
        schema.setProperty("bar", "baz");
