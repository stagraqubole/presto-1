...
public class HiveACIDState
{
    ...
    public HiveACIDState setHeartBeatTask(ScheduledExecutorService heartBeater, HiveMetastore metastore)
    {
        ...
        heartBeatTask = heartBeater.scheduleWithFixedDelay(
                new HiveACIDState.HeartbeatRunnable(txnId.get(), metastore, txnValidAtMetastore),
            ...
            implements Runnable
    {
        ...
        public HeartbeatRunnable(long txnId, HiveMetastore metastore, AtomicBoolean valid)
        {
            this.txnId = txnId;
